    ...
    <div>
      <div className="h-[290px] 2xl:h-[350px] mb-5 relative">
        <Image
          ...
          className="w-full object-cover bottom-0 "
          width="50"
          height="50"
        />
        <div className="w-[100px] absolute bottom-[10px] py-2 left-0 z-10 bg-sec text-black flex justify-center items-center">
          <p className="text-[10px] capitalize">lorem ipsum</p>
        </div>
      </div>
      <div>
        <p className="h4-text font-[600]">Lorem ipsum dolor sit amen </p>
